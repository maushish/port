...
export default function Home() {
  return (
    <header >
      ...
      <h1 className='text-white text-lund absolute left-[50vh] top-[35vh] font-bold'>MAUSHISH</h1>
      <p className=' text-gray-400 text-5xl absolute top-[65vh] left-[65vh]'>A 19 Yr Old boi who just wanna code!</p>
      <a>
        <button className='px-12 py-4 border-4 text-4xl  rounded-full absolute right-[70vh] top-[80vh] text-white'>RESUME</button>
      </a>
      <a>
        <button className='px-12 py-4  border-4 text-4xl rounded-full absolute left-[70vh] top-[80vh] text-white'>LET'S WORK</button>
      </a>
